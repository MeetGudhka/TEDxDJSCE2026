...
const SpeakerSlider = () => {
    ...
    useEffect(() => {
        ...
        // High-performance Auto-Rotation Ticker
        const rotateTicker = () => {
            const isModalOpen = modalOverlayRef.current && modalOverlayRef.current.style.display === 'flex';
        ...
        // Setup dragging - Robust Proxy approach
        ...
        const draggables = Draggable.create(proxy, {
            ...
            inertia: true,
            onDrag: function () {
                rotationRef.current = this.x * 0.25;
                gsap.set(ringRef.current, { rotationY: rotationRef.current });
            },
